...
class Dokter extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template','dokter_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'spesialis' => $row->spesialis,
            ...
            $this->template->load('template','dokter_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','dokter_form', $data);
    }
    ...
    public function word()
    {
        ...
        $this->load->view('dokter_doc',$data);
    }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2018-09-22 22:58:57 */
/* http://harviacode.com */