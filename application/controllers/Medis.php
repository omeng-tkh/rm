...
class Medis extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        is_login();
        $this->load->model('View_kontrol_model');
    ...
    public function json() {
        ...
        echo $this->View_kontrol_model->json();
    }

    public function read($id) 
    {
        $row = $this->View_kontrol_model->get_by_id($id);
        if ($row) {
            $data = array(
		'no_rm' => $row->no_rm,
		'tanggal' => $row->tanggal,
    ...
    public function create_action() 
    {
		...
		'keterangan' => $this->input->post('keterangan',TRUE),
            ...
            $this->View_kontrol_model->insert($data);
    ...
    public function update_action() 
    {
		...
		'keterangan' => $this->input->post('keterangan',TRUE),
            ...
            $this->View_kontrol_model->update($this->input->post('', TRUE), $data);
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->View_kontrol_model->delete($id);
	...
	foreach ($this->View_kontrol_model->get_all() as $data) {
            $kolombody = 0;
    ...
    public function word()
    {
        ...
        $data = array(
            'view_kontrol_data' => $this->View_kontrol_model->get_all(),
            'start' => 0
        );
