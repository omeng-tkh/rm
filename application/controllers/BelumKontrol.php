...
class BelumKontrol extends CI_Controller
{
    ...
    public function json() {
        ...
        echo $this->Belum_kontrol_model->json();
    }
    ...
    public function create_action() 
    {
		...
		'keterangan' => $this->input->post('keterangan',TRUE),
            ...
            $this->Belum_kontrol_model->insert($data);
    ...
    public function update_action() 
    {
		...
		'keterangan' => $this->input->post('keterangan',TRUE),
            ...
            $this->Belum_kontrol_model->update($this->input->post('', TRUE), $data);
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Belum_kontrol_model->delete($id);
	...
	foreach ($this->Belum_kontrol_model->get_all() as $data) {
            $kolombody = 0;
